...
plot(sub_data$time, sub_data$global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
...
plot(sub_data$time, sub_data$global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type="l")
